...
class SdfSdu(models.Model):
    ...
    street = models.CharField(_('街道'), max_length=25, unique=False, null=True, default='')
    #slug = models.SlugField(_('Slug'), max_length=100, unique=True)
    ...
    evaluate_rent = models.DecimalField(_('評估租金'), decimal_places=2, max_digits=10, default=0.0, null=True)
