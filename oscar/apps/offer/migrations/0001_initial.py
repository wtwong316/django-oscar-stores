    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_basket_applications', models.PositiveIntegerField(blank=True, help_text='The number of times this offer can be applied to a basket (and inquiry)', null=True, verbose_name='Max basket applications')),
                ('max_discount', models.DecimalField(blank=True, decimal_places=2, help_text='When an offer has given more discount to inquiries than this threshold, then the offer becomes unavailable', max_digits=12, null=True, verbose_name='Max discount')),
                ...
                ('num_inquiries', models.PositiveIntegerField(default=0, verbose_name='Number of Inquiries')),
