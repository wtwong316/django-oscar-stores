    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_order', models.PositiveSmallIntegerField(db_index=True, default=0, help_text='Higher the number, higher the country in the list.', verbose_name='Display inquiry')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line2', models.CharField(blank=True, max_length=255, verbose_name='Street number')),
                ('line3', models.CharField(blank=True, max_length=255, verbose_name='Building')),
                ('line4', models.CharField(blank=True, max_length=255, verbose_name='Floor')),
                ('line5', models.CharField(blank=True, max_length=255, verbose_name='Room')),
                ('line6', models.CharField(blank=True, max_length=255, verbose_name='District')),
                ...
                ('num_inquiries_as_shipping_address', models.PositiveIntegerField(default=0, verbose_name='Number of Inquiries as Shipping Address')),
                ('num_inquiries_as_billing_address', models.PositiveIntegerField(default=0, verbose_name='Number of Inquiries as Billing Address')),
