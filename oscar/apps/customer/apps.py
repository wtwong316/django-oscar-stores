...
class CustomerConfig(OscarConfig):
    ...
    def ready(self):
        ...
        self.wishlists_add_sdu_view = get_class('customer.wishlists.views',
                                                    'WishListAddSdu')
        ...
        self.wishlists_create_view = get_class('customer.wishlists.views',
                                               'WishListCreateView')
        self.wishlists_create_with_sdu_view = get_class('customer.wishlists.views',
                                                            'WishListCreateView')
        ...
        self.wishlists_delete_view = get_class('customer.wishlists.views',
                                               'WishListDeleteView')
        self.wishlists_remove_sdu_view = get_class('customer.wishlists.views',
                                                       'WishListRemoveSdu')
        self.wishlists_move_sdu_to_another_view = get_class(
            'customer.wishlists.views', 'WishListMoveSduToAnotherWishList')
