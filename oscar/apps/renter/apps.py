...
class RenterConfig(OscarConfig):
    label = 'renter'
    name = 'oscar.apps.renter'
    ...
    def ready(self):
        ...
        self.address_update_view = get_class('renter.views', 'AddressUpdateView')
        self.address_delete_view = get_class('renter.views', 'AddressDeleteView')
        self.address_change_status_view = get_class('renter.views',
                                                    'AddressChangeStatusView')

        self.email_list_view = get_class('renter.views', 'EmailHistoryView')
        self.email_detail_view = get_class('renter.views', 'EmailDetailView')
        self.login_view = get_class('renter.views', 'AccountAuthView')
        self.logout_view = get_class('renter.views', 'LogoutView')
        self.register_view = get_class('renter.views', 'AccountRegistrationView')
        self.profile_view = get_class('renter.views', 'ProfileView')
        self.profile_update_view = get_class('renter.views', 'ProfileUpdateView')
        self.profile_delete_view = get_class('renter.views', 'ProfileDeleteView')
        self.change_password_view = get_class('renter.views', 'ChangePasswordView')
