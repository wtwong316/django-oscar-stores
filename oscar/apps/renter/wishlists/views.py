...
class WishListListView(PageTitleMixin, ListView):
    ...
    template_name = 'oscar/renter/wishlists/wishlists_list.html'
...
class WishListDetailView(PageTitleMixin, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('renter:wishlists-detail', key=self.object.key)
...
class WishListCreateView(WishListCreateUpdateViewMixin, CreateView):
    ...
    """
    model = WishList
    template_name = 'oscar/renter/wishlists/wishlists_form.html'
    active_tab = "wishlists"
...
class WishListDeleteView(PageTitleMixin, DeleteView):
    model = WishList
    template_name = 'oscar/renter/wishlists/wishlists_delete.html'
    active_tab = "wishlists"
