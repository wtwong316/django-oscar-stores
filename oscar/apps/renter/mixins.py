...
from oscar.apps.renter.signals import user_registered
...
logger = logging.getLogger('oscar.renter')
...
class RegisterUserMixin(object):
    ...
    def send_registration_email(self, user):
        ...
        RenterDispatcher().send_registration_email_for_user(user, extra_context)
