...
from oscar.apps.renter.utils import get_password_reset_url
...
class AccountRegistrationView(RegisterUserMixin, generic.FormView):
    ...
    template_name = 'oscar/renter/registration.html'
...
class AccountAuthView(RegisterUserMixin, generic.TemplateView):
    """
    This is actually a slightly odd double form view that allows a renter to
    either login or register.
    """
    template_name = 'oscar/renter/login_registration.html'
...
class ProfileView(PageTitleMixin, generic.TemplateView):
    template_name = 'oscar/renter/profile/profile.html'
...
class ProfileUpdateView(PageTitleMixin, generic.FormView):
    ...
    template_name = 'oscar/renter/profile/profile_form.html'
    page_title = _('Edit Profile')
    active_tab = 'profile'
    success_url = reverse_lazy('renter:profile-view')
    ...
    def send_email_changed_email(self, old_user, new_email):
        ...
        RenterDispatcher().send_email_changed_email_for_user(old_user, extra_context)


class ProfileDeleteView(PageTitleMixin, generic.FormView):
    form_class = ConfirmPasswordForm
    template_name = 'oscar/renter/profile/profile_delete.html'
...
class ChangePasswordView(PageTitleMixin, generic.FormView):
    ...
    template_name = 'oscar/renter/profile/change_password_form.html'
    ...
    def send_password_changed_email(self):
        ...
        RenterDispatcher().send_password_changed_email_for_user(user, extra_context)
...
class EmailHistoryView(PageTitleMixin, generic.ListView):
    ...
    def get_queryset(self):
        """
        Return Queryset of :py:class:`Email <oscar.apps.renter.abstract_models.AbstractEmail>`
...
class AddressListView(PageTitleMixin, generic.ListView):
    ...
    template_name = 'oscar/renter/address/address_list.html'
    paginate_by = settings.OSCAR_ADDRESSES_PER_PAGE
    active_tab = 'addresses'
    page_title = _('Address Book')

    def get_queryset(self):
        """Return renter's addresses"""
...
class AddressCreateView(PageTitleMixin, generic.CreateView):
    ...
    model = UserAddress
    template_name = 'oscar/renter/address/address_form.html'
    active_tab = 'addresses'
    page_title = _('Add a new address')
    success_url = reverse_lazy('renter:address-list')
...
class AddressDeleteView(PageTitleMixin, generic.DeleteView):
    model = UserAddress
    template_name = "oscar/renter/address/address_delete.html"
...
class AddressChangeStatusView(generic.RedirectView):
    ...
    """
    url = reverse_lazy('renter:address-list')
    permanent = False
